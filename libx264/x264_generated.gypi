  ...
  'variables': {
    ...
    'conditions': [
      ['(target_arch == "ia32" or target_arch == "x64") and (1) and (1)', {
        ...
        'converter_outputs': [
          '<(shared_generated_dir)/x264_src/common/bitstream.c',
          '<(shared_generated_dir)/x264_src/common/cabac.c',
          '<(shared_generated_dir)/x264_src/common/common.c',
          '<(shared_generated_dir)/x264_src/common/cpu.c',
          '<(shared_generated_dir)/x264_src/common/dct.c',
          '<(shared_generated_dir)/x264_src/common/deblock.c',
          '<(shared_generated_dir)/x264_src/common/frame.c',
          '<(shared_generated_dir)/x264_src/common/macroblock.c',
          '<(shared_generated_dir)/x264_src/common/mc.c',
          '<(shared_generated_dir)/x264_src/common/mvpred.c',
          '<(shared_generated_dir)/x264_src/common/osdep.c',
          '<(shared_generated_dir)/x264_src/common/pixel.c',
          '<(shared_generated_dir)/x264_src/common/predict.c',
          '<(shared_generated_dir)/x264_src/common/quant.c',
          '<(shared_generated_dir)/x264_src/common/rectangle.c',
          '<(shared_generated_dir)/x264_src/common/set.c',
          '<(shared_generated_dir)/x264_src/common/threadpool.c',
          '<(shared_generated_dir)/x264_src/common/vlc.c',
          '<(shared_generated_dir)/x264_src/common/x86/mc-c.c',
          '<(shared_generated_dir)/x264_src/common/x86/predict-c.c',
          '<(shared_generated_dir)/x264_src/encoder/analyse.c',
          '<(shared_generated_dir)/x264_src/encoder/cabac.c',
          '<(shared_generated_dir)/x264_src/encoder/cavlc.c',
          '<(shared_generated_dir)/x264_src/encoder/encoder.c',
          '<(shared_generated_dir)/x264_src/encoder/lookahead.c',
          '<(shared_generated_dir)/x264_src/encoder/macroblock.c',
          '<(shared_generated_dir)/x264_src/encoder/me.c',
          '<(shared_generated_dir)/x264_src/encoder/ratecontrol.c',
          '<(shared_generated_dir)/x264_src/encoder/set.c',
        ],
      }],  # (target_arch == "ia32" or target_arch == "x64") and (1) and (1)
      ['target_arch == "x64"', {
        'asm_sources': [
